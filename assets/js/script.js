(function ($) {
         ...
         if ($pi.length) {
            if ($pi.hasClass('pi-full')) {
               ...
               if ($piPagination.length) {
                  $piPagination.wrap(
                     '<div class="pi-pagination-appear"></div>'
                  );
                  tl_transitOut.from(
               ...
               $ttContentCarousel
                  ...
                  .on('mousedown touchstart pointerdown', function (e) {
                     if (e.which === 1) {
                        // Affects the left mouse button only!
                        gsap.to(
                           $ttContentCarousel.find('.tt-content-carousel-item'),
                           {
                              duration: 0.7,
                              scale: 0.9,
                           }
   ...
   //Display Whats App button
   $('#body-inner').prepend(
      '<div class="tt-stsw-whatsapp">' +
         '<a href="https://wa.me/+917259678122" target="_blank">' +
   ...
   if ($('#tt-light-style-default').length) {
      ...
      d == 'true'
         ? ($('body').addClass('tt-light-style-default-on'),
           $('.tt-style-switch'))
